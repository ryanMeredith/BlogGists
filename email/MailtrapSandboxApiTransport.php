 ...
 */
final class MailtrapSandboxApiTransport extends AbstractApiTransport
{
    private const HOST = 'sandbox.api.mailtrap.io';
    ...
    {
        $response = $this->client->request('POST', 'https://' . $this->getEndpoint() . '/api/send/' . $this->mailboxId, [
